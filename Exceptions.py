...
class AirlineDoesNotExist(Exception):
    def __init__(self, msg="airline does not exist"):
        self.msg = msg
...
class UnknownError(Exception):
    def __init__(self, message="uknown error"):
        self.message = message
        super().__init__(self.message)
...
class WorngToken(Exception):
    def __init__(self, loginToken, message="Worng Login Token"):
        self.message = message
