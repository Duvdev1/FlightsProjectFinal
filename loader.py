...
class loader:
    def __init__(self):
        ...
        admin_user = User(user_name='roy_admin', password='Aa12', email='a1242@gmail.com', user_role=1)
        self.anonymous_facade.add_user(admin_user)
        customer_user = User(user_name='roy_customer', password='Aa12', email='a12144@gmail.com', user_role=2)
        self.anonymous_facade.add_user(customer_user)
        airline_user = User(user_name='roy_airline', password='Aa12', email='a532522@gmail.com', user_role=3)
    ...
    def country_loader(self):
        number = 10
        _list = []
        with open('C:\Users\user\Desktop\project flight\countries.json', 'r') as f:
            _set = set()
            j = json.load(f)
            num = 1
            for country in j:
    ...
    def airline_loader(self, number):
        with open('C:\Users\user\Desktop\project flight\airline_companies.json', 'r') as f:
            _set = set()
            j = json.load(f)
            num = 1
